...
/**
 ...
 Internal Information: de.d1strict.wsc.plugin.medaltv_profilefield
...
class D1MedalTVUserOptionOutput implements IUserOptionOutput {
...
public function getOutput(User $user, UserOption $option, $value) {
		...
		$link = 'https://medal.tv/users/' . $value;
